...
if __name__ == '__main__':
    # charmETIV(
    #     inputDir="/home/ahmadkhana/Desktop/etiv-comparison/charm_ext/results",
    #     inputFile="final_tissues_MNI_to_subj.nii.gz",
    #     outputFile="/home/ahmadkhana/Desktop/etiv-comparison/charm_ext/log/etiv_estimation.csv"
    # )

    ## To take manually labeled files as basis and computing the eTIV every n slices
    subjectIDs = ["HCP_133625", "adni_20329"]
    inputFiles = ["/home/ahmadkhana/Desktop/etiv-comparison/charm_ext/results/results_vinn-labels/m2m_HCP_133625/final_tissues_MNI_to_subj.nii.gz", "/home/ahmadkhana/Desktop/etiv-comparison/charm_ext/results/results_vinn-labels/m2m_adni_20329/final_tissues_MNI_to_subj.nii.gz"]
    ...
    charmETIVEveryn(
        ...
        outputFile="/home/ahmadkhana/Desktop/etiv-comparison/charm_ext/log/etiv_estimation_every_n.csv",
        labelOutputFile="/home/ahmadkhana/Desktop/etiv-comparison/charm_ext/log/etiv_estimation_ground_truth.csv"
    )