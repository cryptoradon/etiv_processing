...
#SBATCH --output /home/ahmadkhana/Desktop/etiv-comparison/charm/log/slurm_output/%A_%a.out # saves output as (jobID)_out.out 
#SBATCH --error /home/ahmadkhana/Desktop/etiv-comparison/charm/log/slurm_output/%A_%a.err # saves error as (jobID)_err.out 
#SBATCH --ntasks=7
...
for subj_i in $(seq 0 $((SUBJECTS_PER_JOB - 1))); do
    ...
    if [ -f "$nii_file" ]; then
        ...
        cd "$OUTPUT_DIR"
        /home/ahmadkhana/SimNIBS-4.5/bin/charm $subj $nii_file --forcesform --forcerun&
    else
